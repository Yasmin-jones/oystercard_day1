...
describe Oystercard do
  ...
  describe 'Can touch in and touch out' do
  ...
  #  describe '#Check doubles work' do 
  # 
  ...
  # end
   ...
   describe '#list of journeys' do 
    ...
    context 'No journeys started' do
    ...
    context 'Journey completed' do
      ...
      it ' Touch in and touch out create one journey' do 
        subject.top_up(Oystercard::MIN_CHARGE) 
        subject.touch_in(:station_double)
        subject.touch_out(:station_double_exit)
      ...
      it ' Stores a specfic journey' do 
        subject.top_up(Oystercard::MIN_CHARGE) 
        subject.touch_in(:station_double)
        subject.touch_out(:station_double_exit)
